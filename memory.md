...
- [ ] 排查 Python 3.12 环境依赖安装卡在 starknet-crypto-py 构建问题
- [ ] 用户选择方案 A（切换 Python 3.11），等待 SSH 登录信息执行
- [ ] 已确认 SSH 端口 22 且可执行操作，等待私钥内容/路径以便登录

**下一步计划**:
- [ ] 获取/确认 SSH 登录方式与端口，进入服务器执行切换与安装
- [ ] 登录后按方案 A 完成 Python 3.11 环境与依赖安装
